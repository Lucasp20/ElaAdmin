			...
			<div class="animated fadeIn">
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="card">
							<div class="card-body">
								<h1 class="box-title">Pesquisa de Usuário</h1>
							</div>
							
							<c:if test="${usuarios != null and empty usuarios}">
							...
							<div class="card-body">
								<form id="form_pesquisa" method="post" action="do_usuario?cmd=pesquisarPorNome">
								...
								<c:if test="${not empty usuarios}">
										<div class="form-group row" >
											<table class="table table-striped table-responsive-md">
												...
												<tbody>
													<c:forEach var="usuario" items="${usuarios}" varStatus="linha">
														<tr>
															...
															<td>
																<a href="do_usuario?cmd=carregar_alterar&id=${usuario.id}" title="Alterar"><i class="fa fa-pencil fa-fw" aria-hidden="true"></i></a>
															&nbsp;
															<a href="do_usuario?cmd=excluir&id=${usuario.id}" title="Remover"><i class="fa fa-trash fa-fw" aria-hidden="true"></i></a>
															</td>
														</tr>
													</c:forEach>
												</tbody>
