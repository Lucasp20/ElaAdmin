			...
			<div class="animated fadeIn">
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="card">
							<div class="card-body">
								<h1 class="box-title">Gerenciar Usuário</h1>
							</div>
									...
									<div class="form-group">
										<label for="nome">Nome</label> 
											...
											<input type="text" class="form-control" id="nome" value="${usuario.nome}"
												placeholder="Digite o seu nome" name="nome">
									</div>

									<div class="form-group">
										<label for="login">Login</label> 
											<input type="text" class="form-control" id="login" value="${usuario.login}"
												placeholder="Digite o login" name="login">
									</div>
									<div class="form-group">
										<label for="senha">Senha</label> 
											<input type="password" class="form-control" id="senha" value="${usuario.senha}"
