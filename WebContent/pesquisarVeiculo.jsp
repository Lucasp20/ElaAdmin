			...
			<div class="animated fadeIn">
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="card">
							<div class="card-body">
								<h1 class="box-title">Pesquisa de Veículo</h1>
							</div>
							
							<c:if test="${veiculos != null and empty veiculos}">
							...
							<div class="card-body">
								<form id="form_pesquisa" method="post"
									action="do_veiculo?cmd=pesquisarPorModelo">
									<div class="form-group row">
										...
										<div class="col-sm-6">
											<input type="text" name="modelo" class="form-control"
												id="modelo" placeholder="Digite o modelo">
										</div>
								...
								<c:if test="${not empty veiculos}">
									<div class="form-group row">
										<table class="table table-striped table-responsive-md">
											...
											<tbody>
												<c:forEach var="veiculo" items="${veiculos}" varStatus="linha">
													<tr>
														...
														<td>
															<f:formatNumber value="${veiculo.valor}" type="currency"/>
														</td>
														
														<td>
															<a href="do_veiculo?cmd=carregar_alterar&id=${veiculo.id}" title="Alterar"><i class="fa fa-pencil fa-fw" aria-hidden="true"></i></a>
															&nbsp;
															<a href="do_veiculo?cmd=excluir&id=${veiculo.id}" title="Remover"><i class="fa fa-trash fa-fw" aria-hidden="true"></i></a>
